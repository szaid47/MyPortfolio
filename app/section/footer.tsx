	...
	return (
		<aside>
			<ul className="flex flex-row flex-wrap md:flex-row mt-8 space-x-4 space-y-0 md:space-x-4 md:space-y-0 font-sm text-neutral-600 dark:text-neutral-300">
				<SocialsLink url="https://www.linkedin.com/in/syedzaheed/" title="Linkedin" />
				<SocialsLink url="mailto:syedzaheed2004@gmail.com" title="Email" />
				<SocialsLink url="https://github.com/szaid47" title="Github" />
			</ul>
		</aside>
	);
};
